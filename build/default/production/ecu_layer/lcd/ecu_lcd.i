...
# 1 "ecu_layer/lcd/../../mcal_layer/GPIO/../../mcal_layer/device_conf.h" 1
# 11 "ecu_layer/lcd/../../mcal_layer/GPIO/../../mcal_layer/device_conf.h"
...
# 11 "ecu_layer/lcd/../../mcal_layer/GPIO/../../mcal_layer/device_conf.h" 2
...
# 1 "ecu_layer/lcd/../../mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h" 1
# 10 "ecu_layer/lcd/../../mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h"
...
# 10 "ecu_layer/lcd/../../mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
# 12 "ecu_layer/lcd/../../mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
# 29 "ecu_layer/lcd/../../mcal_layer/GPIO/../mcal_std_types.h"
...
std_ReturnType lcd_4bit_init(const lcd_4bit_t *lcd ){
    ...
    if(((void*)0) == lcd)
    {
        ...
        RET_VAL = lcd_4bit_send_command(lcd , 0X38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        RET_VAL = lcd_4bit_send_command(lcd , 0X38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        RET_VAL = lcd_4bit_send_command(lcd , 0X38);
        RET_VAL = lcd_4bit_send_command(lcd , 0X01);
        RET_VAL = lcd_4bit_send_command(lcd , 0X02);
        RET_VAL = lcd_4bit_send_command(lcd , 0X06);
        RET_VAL = lcd_4bit_send_command(lcd , 0X0C);
        RET_VAL = lcd_4bit_send_command(lcd , 0X28);
...
std_ReturnType lcd_8bit_init(const lcd_8bit_t *lcd ){
    ...
    if(((void*)0) == lcd)
    {
        ...
        _delay((unsigned long)((20)*(8000000UL/4000.0)));
        RET_VAL = lcd_8bit_send_command(lcd , 0X38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        RET_VAL = lcd_8bit_send_command(lcd , 0X38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        RET_VAL = lcd_8bit_send_command(lcd , 0X38);
        RET_VAL = lcd_8bit_send_command(lcd , 0X01);
        RET_VAL = lcd_8bit_send_command(lcd , 0X02);
        RET_VAL = lcd_8bit_send_command(lcd , 0X06);
        RET_VAL = lcd_8bit_send_command(lcd , 0X0C);
        RET_VAL = lcd_8bit_send_command(lcd , 0X38);
...
std_ReturnType lcd_8bit_send_custom_char(const lcd_8bit_t *lcd , char row , char column ,char _char[] , char mem_pos ){
    ...
    if(((void*)0) == lcd)
    {
        ...
        RET_VAL = lcd_8bit_send_command( lcd , (0X40 + mem_pos*8));
...
std_ReturnType lcd_8bit_set_cursor(const lcd_8bit_t *lcd , char row , char column){
    ...
    if(((void*)0) == lcd )
    {
        ...
        column--;
        switch(row){
            case 0 : RET_VAL = lcd_8bit_send_command(lcd , (0x80 + column)); break ;
            case 1 : RET_VAL = lcd_8bit_send_command(lcd , (0xC0 + column)); break ;
            case 2 : RET_VAL = lcd_8bit_send_command(lcd , (0x94 + column)); break ;
            case 3 : RET_VAL = lcd_8bit_send_command(lcd , (0xD4 + column)); break ;
            default : ;
        }
...
std_ReturnType lcd_4bit_set_cursor(const lcd_4bit_t *lcd , char row , char column){
    ...
    if(((void*)0) == lcd )
    {
        ...
        column--;
        switch(row){
            case 0 : RET_VAL = lcd_4bit_send_command(lcd , (0x80 + column)); break ;
            case 1 : RET_VAL = lcd_4bit_send_command(lcd , (0xC0 + column)); break ;
            case 2 : RET_VAL = lcd_4bit_send_command(lcd , (0x94 + column)); break ;
            case 3 : RET_VAL = lcd_4bit_send_command(lcd , (0xD4 + column)); break ;
            default : ;
        }
