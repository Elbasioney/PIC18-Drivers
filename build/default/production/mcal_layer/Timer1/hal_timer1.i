...
# 1 "mcal_layer/Timer1/../GPIO/../../mcal_layer/device_conf.h" 1
...
# 1 "mcal_layer/Timer1/../GPIO/../../mcal_layer/mcal_std_libararies.h" 1
# 10 "mcal_layer/Timer1/../GPIO/../../mcal_layer/mcal_std_libararies.h"
...
# 10 "mcal_layer/Timer1/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
# 12 "mcal_layer/Timer1/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
# 12 "mcal_layer/Timer1/../GPIO/../mcal_std_types.h" 2

# 1 "mcal_layer/Timer1/../GPIO/../../mcal_layer/compiler.h" 1
# 13 "mcal_layer/Timer1/../GPIO/../mcal_std_types.h" 2
# 29 "mcal_layer/Timer1/../GPIO/../mcal_std_types.h"
...
# 16 "mcal_layer/Timer1/../interrupt/mcal_interrupt_config.h"
...
# 26 "mcal_layer/Timer1/hal_timer1.c"
std_ReturnType Timer1_Init(timer1_config_t *timer1){
    ...
    if(((void*)0) ==timer1){
        ...
        TMR1H = ((timer1->preloaded_value) >> 8);
        TMR1L = (uint8_t)(timer1->preloaded_value);
        timer1_preloaded_value = timer1->preloaded_value ;

        ( PIE1bits.TMR1IE = 1 );
        ( PIR1bits.TMR1IF = 0 );
        TIMER1_INTERRUPT_HANDLER = timer1->timer1_interrupt_handler ;
...
static __attribute__((inline)) void Timer1_mode_select(const timer1_config_t *timer1){
    if(timer1->timer1_mode == 0x01U){
        (T1CONbits.TMR1CS = 1 );
    }else if(timer1->timer1_mode == 0x00U){
        (T1CONbits.TMR1CS = 0 );
    }else{
