...
# 1 "mcal_layer/EUSART/../GPIO/../../mcal_layer/device_conf.h" 1
# 12 "mcal_layer/EUSART/../GPIO/hal_gpio.h" 2

# 1 "mcal_layer/EUSART/../GPIO/../mcal_std_types.h" 1
# 12 "mcal_layer/EUSART/../GPIO/../mcal_std_types.h"
# 1 "mcal_layer/EUSART/../GPIO/../../mcal_layer/mcal_std_libararies.h" 1
# 10 "mcal_layer/EUSART/../GPIO/../../mcal_layer/mcal_std_libararies.h"
...
# 10 "mcal_layer/EUSART/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
# 12 "mcal_layer/EUSART/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
# 12 "mcal_layer/EUSART/../GPIO/../mcal_std_types.h" 2

# 1 "mcal_layer/EUSART/../GPIO/../../mcal_layer/compiler.h" 1
# 13 "mcal_layer/EUSART/../GPIO/../mcal_std_types.h" 2
# 29 "mcal_layer/EUSART/../GPIO/../mcal_std_types.h"
typedef uint8_t std_ReturnType ;
# 13 "mcal_layer/EUSART/../GPIO/hal_gpio.h" 2
# 35 "mcal_layer/EUSART/../GPIO/hal_gpio.h"
typedef enum {
    LOW = 0 ,
    HIGH
}logic_t;
...
# 13 "mcal_layer/EUSART/../interrupt/mcal_internal_interrupt.h"
# 1 "mcal_layer/EUSART/../interrupt/mcal_interrupt_config.h" 1
# 16 "mcal_layer/EUSART/../interrupt/mcal_interrupt_config.h"
# 1 "mcal_layer/EUSART/../interrupt/mcal_interrupt_gen_cfg.h" 1
# 16 "mcal_layer/EUSART/../interrupt/mcal_interrupt_config.h" 2
# 60 "mcal_layer/EUSART/../interrupt/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0 ,
    INTERRUPT_HIGH_PRIORITY
}interrupt_INTx_priority;
# 13 "mcal_layer/EUSART/../interrupt/mcal_internal_interrupt.h" 2
# 18 "mcal_layer/EUSART/hal_EUSART.h" 2
# 67 "mcal_layer/EUSART/hal_EUSART.h"
typedef enum {
...
void (*EUSART_TX_INTERRUPT_HANDLER)(void) = ((void*)0);



void (*EUSART_RX_INTERRUPT_HANDLER)(void) = ((void*)0);
void (*EUSART_FERR_INTERRUPT_HANDLER)(void) = ((void*)0);
void (*EUSART_OERR_INTERRUPT_HANDLER)(void) = ((void*)0);
...
std_ReturnType EUSART_Asynchronous_Init(const eusart_t *eusart) {
    ...
    if (((void*)0) == eusart) {
        ...
        EUSART_TX_Init(eusart);
        EUSART_RX_Init(eusart);
        RCSTAbits.SPEN = 1;
        RET_VAL = (std_ReturnType)0x01;
    }
    return RET_VAL;
}
...
static void EUSART_baud_rate_calculations(const eusart_t *eusart) {
    ...
    switch (eusart->baud_rate_config) {
        case BAUD_RATE_ASYNCHRONOUS_8BIT_LOW_SPEED:
            ...
            TXSTAbits.BRGH = 0;
            BAUDCONbits.BRG16 = 0;
            baud_rate_temp_value = ((8000000UL / (float) (eusart->baud_rate_value)) / 64) - 1;
            break;
        case BAUD_RATE_ASYNCHRONOUS_16BIT_LOW_SPEED:
            TXSTAbits.SYNC = 0;
            TXSTAbits.BRGH = 0;
            BAUDCONbits.BRG16 = 1;
            baud_rate_temp_value = ((8000000UL / (float) (eusart->baud_rate_value)) / 16) - 1;
            break;
        ...
        case BAUD_RATE_ASYNCHRONOUS_16BIT_HIGH_SPEED:
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 1;
            baud_rate_temp_value = ((8000000UL / (float) (eusart->baud_rate_value)) / 4) - 1;
            break;
...
static void EUSART_TX_Init(const eusart_t *eusart) {
    if (eusart->tx_cfg.eusart_tx_module_enable == 1) {
        TXSTAbits.TXEN = 1;
        if (eusart->tx_cfg.eusart_tx_interrupt_enable == 1) {
            PIE1bits.TXIE = 1;

            EUSART_TX_INTERRUPT_HANDLER = (eusart->TX_interrupt_handler);
# 161 "mcal_layer/EUSART/hal_EUSART.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
            ( PIE1bits.TXIE = 1 );


        } else if (eusart->tx_cfg.eusart_tx_interrupt_enable == 0) {
            ( PIE1bits.TXIE = 0 );
        } else {

        }
        if (eusart->tx_cfg.eusart_tx_9bit_enable == 1) {
            TXSTAbits.TX9 = 1;
        } else if (eusart->tx_cfg.eusart_tx_9bit_enable == 0) {
            TXSTAbits.TX9 = 0;
        } else {
...
static void EUSART_RX_Init(const eusart_t *eusart) {
    if (eusart->rx_cfg.eusart_rx_module_enable == 1) {
        RCSTAbits.CREN = 1;
        if (eusart->rx_cfg.eusart_rx_interrupt_enable == 1) {
...
# 205 "mcal_layer/EUSART/hal_EUSART.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
            ( PIE1bits.RCIE = 1 );


        } else if (eusart->rx_cfg.eusart_rx_interrupt_enable == 0) {
            ( PIE1bits.RCIE = 0 );
        } else {

        }
        if (eusart->rx_cfg.eusart_rx_9bit_enable == 1) {
            RCSTAbits.RX9 = 1;
        } else if (eusart->rx_cfg.eusart_rx_9bit_enable == 0) {
            RCSTAbits.RX9 = 0;
        } else {
