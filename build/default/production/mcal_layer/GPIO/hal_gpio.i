...
# 11 "mcal_layer/GPIO/../../mcal_layer/device_conf.h"
...
# 11 "mcal_layer/GPIO/../../mcal_layer/device_conf.h" 2
# 12 "mcal_layer/GPIO/hal_gpio.h" 2

# 1 "mcal_layer/GPIO/../mcal_std_types.h" 1
# 12 "mcal_layer/GPIO/../mcal_std_types.h"
# 1 "mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h" 1
# 10 "mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h"
...
# 10 "mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
# 12 "mcal_layer/GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
std_ReturnType gpio_pin_direction_initialize(const pin_config_t * _pin_config) {
    ...
    if (((void*)0) == _pin_config || _pin_config->pin > (8 - 1) || _pin_config->port > (5 - 1)) {
        ...
        switch (_pin_config->direction) {
            case OUTPUT:
                (*(TRIS_reg[_pin_config->port]) &= ~((uint8_t)0x01 << _pin_config->pin));
                break;
            case INPUT:
                (*(TRIS_reg[_pin_config->port]) |= ((uint8_t)0x01 << _pin_config->pin));
                break;
...
std_ReturnType gpio_pin_get_direction(const pin_config_t * _pin_config, direction_t * dir_status) {
    std_ReturnType ret_val = (std_ReturnType)0x01;
    if (((void*)0) == _pin_config || ((void*)0) == dir_status || _pin_config->pin > (8 - 1) || _pin_config->port > (5 - 1)) {
        ret_val = (std_ReturnType)0x00;
    } else {
        *dir_status = ((*(TRIS_reg[_pin_config->port]) >> _pin_config->pin) & (uint8_t)0x01);
    }
    return ret_val;
...
std_ReturnType gpio_pin_write_logic(const pin_config_t * _pin_config, logic_t logic) {
    ...
    if (((void*)0) == _pin_config || _pin_config->pin > (8 - 1) || _pin_config->port > (5 - 1)) {
        ...
        switch (logic) {
            case LOW:
                (*LAT_reg[_pin_config->port] &= ~((uint8_t)0x01 << _pin_config->pin));
                break;
            case HIGH:
                (*LAT_reg[_pin_config->port] |= ((uint8_t)0x01 << _pin_config->pin));
                break;
...
std_ReturnType gpio_pin_read_logic(const pin_config_t * _pin_config, logic_t * logic) {
    ...
    if (((void*)0) == _pin_config || ((void*)0) == logic || _pin_config->pin > (8 - 1) || _pin_config->port > (5 - 1)) {
        ...
        *logic = ((*PORT_reg[_pin_config->port] >> _pin_config->pin) & (uint8_t)0x01);
    }
    return ret_val;
}
...
std_ReturnType gpio_port_toggle_logic(port_index_t port) {
    ...
    {
        *LAT_reg[port] = *LAT_reg[port] ^ 0xFF ;
    }
    return ret_val;
}
