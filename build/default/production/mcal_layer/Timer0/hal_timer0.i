...
# 1 "mcal_layer/Timer0/../interrupt/../mcal_std_libararies.h" 1
# 10 "mcal_layer/Timer0/../interrupt/../mcal_std_libararies.h"
...
# 10 "mcal_layer/Timer0/../interrupt/../mcal_std_libararies.h" 2
...
# 12 "mcal_layer/Timer0/../interrupt/../GPIO/hal_gpio.h"
# 1 "mcal_layer/Timer0/../interrupt/../GPIO/../../mcal_layer/device_conf.h" 1
# 12 "mcal_layer/Timer0/../interrupt/../GPIO/hal_gpio.h" 2
# 35 "mcal_layer/Timer0/../interrupt/../GPIO/hal_gpio.h"
typedef enum {
    LOW = 0 ,
    HIGH
}logic_t;
...
# 17 "mcal_layer/Timer0/../interrupt/mcal_interrupt_config.h" 2
...
static __attribute__((inline)) void Timer0_prescaler_config(const timer0_config_t *timer0) ;
static __attribute__((inline)) void Timer0_mode_select(const timer0_config_t *timer0) ;
static __attribute__((inline)) void Timer0_resolution_select(const timer0_config_t *timer0);
static uint16_t timer0_preloaded_value = 0 ;


static void (*TIMER0_INTERRUPT_HANDLER)(void) = ((void*)0);
# 29 "mcal_layer/Timer0/hal_timer0.c"
std_ReturnType Timer0_Init(const timer0_config_t *timer0) {
    ...
    if (((void*)0) == timer0) {
        ...
        timer0_preloaded_value = timer0->preloaded_value ;
...
# 101 "mcal_layer/Timer0/hal_timer0.c"
std_ReturnType Timer0_Read_Value(const timer0_config_t *timer0, uint16_t *value) {
    std_ReturnType RET_VAL = (std_ReturnType)0x00;
...
# 123 "mcal_layer/Timer0/hal_timer0.c"
std_ReturnType Timer0_Write_Value(const timer0_config_t *timer0, uint16_t value) {
    std_ReturnType RET_VAL = (std_ReturnType)0x00;
    if (((void*)0) == timer0) {
        RET_VAL = (std_ReturnType)0x00;
...
static __attribute__((inline)) void Timer0_prescaler_config(const timer0_config_t *timer0){
    if(timer0->prescaler_status == 0x01U){
        (T0CONbits.PSA = 0);
        T0CONbits.T0PS = timer0->prescaler_value ;
    }else if(timer0->prescaler_status == 0x00U){
        (T0CONbits.PSA = 1);
    }else{
...
static __attribute__((inline)) void Timer0_mode_select(const timer0_config_t *timer0){
    if(timer0->mode == 0x00U){
        (T0CONbits.T0CS = 0);
    }else if(timer0->mode == 0x01U){
        (T0CONbits.T0CS = 1);
        if(timer0->edge == 0x01U){
            (T0CONbits.T0SE = 0);
        }else if(timer0->edge == 0x00U){
            (T0CONbits.T0SE = 1);
        }else{
            (T0CONbits.T0SE = 0);
        }
...
static __attribute__((inline)) void Timer0_resolution_select(const timer0_config_t *timer0){
    if(timer0->resolution == 0x01U){
        (T0CONbits.T08BIT = 0);
    }else if(timer0->resolution == 0x00U){
        (T0CONbits.T08BIT = 1);
    }else{
