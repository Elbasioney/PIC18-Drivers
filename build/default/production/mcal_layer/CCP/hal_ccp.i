...
# 1 "mcal_layer/CCP/../GPIO/../../mcal_layer/device_conf.h" 1
# 12 "mcal_layer/CCP/../GPIO/hal_gpio.h" 2

# 1 "mcal_layer/CCP/../GPIO/../mcal_std_types.h" 1
# 12 "mcal_layer/CCP/../GPIO/../mcal_std_types.h"
# 1 "mcal_layer/CCP/../GPIO/../../mcal_layer/mcal_std_libararies.h" 1
# 10 "mcal_layer/CCP/../GPIO/../../mcal_layer/mcal_std_libararies.h"
...
# 10 "mcal_layer/CCP/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
# 12 "mcal_layer/CCP/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
# 12 "mcal_layer/CCP/../GPIO/../mcal_std_types.h" 2

# 1 "mcal_layer/CCP/../GPIO/../../mcal_layer/compiler.h" 1
# 13 "mcal_layer/CCP/../GPIO/../mcal_std_types.h" 2
# 29 "mcal_layer/CCP/../GPIO/../mcal_std_types.h"
...
# 16 "mcal_layer/CCP/../interrupt/mcal_interrupt_config.h"
...
void (* CCP2_interrupt_handler)(void) = ((void*)0);



static __attribute__((inline)) void ccp_interrupt_config(ccp_config_t *ccp);
static __attribute__((inline)) void CCP_CAPTURE_MODE_TIMER_SELECT(ccp_config_t *ccp);
# 30 "mcal_layer/CCP/hal_ccp.c"
std_ReturnType CCP_Init(const ccp_config_t *ccp) {
    ...
    if (((void*)0) == ccp) {
        ...
        if (CCP_CAPTURE_MODE_SELECTED == ccp->mode) {
            if(ccp->ccp_inst == CCP1_INST){
                ...
                case ((uint8_t)0x05): ( CCP1CONbits.CCP1M = ((uint8_t)0x05) );
                    break;
                case ((uint8_t)0x04): ( CCP1CONbits.CCP1M = ((uint8_t)0x04) );
                    break;
                case ((uint8_t)0x06): ( CCP1CONbits.CCP1M = ((uint8_t)0x06) );
                    break;
                case ((uint8_t)0x07): ( CCP1CONbits.CCP1M = ((uint8_t)0x07) );
                    break;
                default: RET_VAL = (std_ReturnType)0x00;
            }
            }else if(ccp->ccp_inst == CCP2_INST){
                switch (ccp->mode_variant) {
                case ((uint8_t)0x05): ( CCP2CONbits.CCP2M = ((uint8_t)0x05) );
                    break;
                case ((uint8_t)0x04): ( CCP2CONbits.CCP2M = ((uint8_t)0x04) );
                    break;
                case ((uint8_t)0x06): ( CCP2CONbits.CCP2M = ((uint8_t)0x06) );
                    break;
                case ((uint8_t)0x07): ( CCP2CONbits.CCP2M = ((uint8_t)0x07) );
                    break;
                default: RET_VAL = (std_ReturnType)0x00;
            }
            }else{
            ...
            if(ccp->ccp_inst == CCP1_INST){
                switch (ccp->mode_variant) {
                case ((uint8_t)0x0B): ( CCP1CONbits.CCP1M = ((uint8_t)0x0B) );
                    break;
                case ((uint8_t)0x0A): ( CCP1CONbits.CCP1M = ((uint8_t)0x0A) );
                    break;
                case ((uint8_t)0x02): ( CCP1CONbits.CCP1M = ((uint8_t)0x02) );
                    break;
                case ((uint8_t)0x09): ( CCP1CONbits.CCP1M = ((uint8_t)0x09) );
                    break;
                case ((uint8_t)0x08): ( CCP1CONbits.CCP1M = ((uint8_t)0x08) );
                    break;
                default: RET_VAL = (std_ReturnType)0x00;
            }
            }else if(ccp->ccp_inst == CCP2_INST){
                switch (ccp->mode_variant) {
                case ((uint8_t)0x0B): ( CCP2CONbits.CCP2M = ((uint8_t)0x0B) );
                    break;
                case ((uint8_t)0x0A): ( CCP2CONbits.CCP2M = ((uint8_t)0x0A) );
                    break;
                case ((uint8_t)0x02): ( CCP2CONbits.CCP2M = ((uint8_t)0x02) );
                    break;
                case ((uint8_t)0x09): ( CCP2CONbits.CCP2M = ((uint8_t)0x09) );
                    break;
                case ((uint8_t)0x08): ( CCP2CONbits.CCP2M = ((uint8_t)0x08) );
                    break;
                default: RET_VAL = (std_ReturnType)0x00;
            }
            }else{
            ...
            if (ccp->ccp_inst == CCP1_INST) {
                if (((uint8_t)0x0C) == ccp->mode_variant) {
        ...
        CCP_CAPTURE_MODE_TIMER_SELECT(ccp);
    }
    return RET_VAL;
}
