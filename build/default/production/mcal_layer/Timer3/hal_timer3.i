...
# 14 "mcal_layer/Timer3/hal_timer3.h"
...
# 1 "mcal_layer/Timer3/../GPIO/../../mcal_layer/device_conf.h" 1
...
# 1 "mcal_layer/Timer3/../GPIO/../../mcal_layer/mcal_std_libararies.h" 1
# 10 "mcal_layer/Timer3/../GPIO/../../mcal_layer/mcal_std_libararies.h"
...
# 10 "mcal_layer/Timer3/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
...
# 12 "mcal_layer/Timer3/../GPIO/../../mcal_layer/mcal_std_libararies.h" 2
# 12 "mcal_layer/Timer3/../GPIO/../mcal_std_types.h" 2

# 1 "mcal_layer/Timer3/../GPIO/../../mcal_layer/compiler.h" 1
# 13 "mcal_layer/Timer3/../GPIO/../mcal_std_types.h" 2
# 29 "mcal_layer/Timer3/../GPIO/../mcal_std_types.h"
...
# 8 "mcal_layer/Timer3/hal_timer3.c" 2
    ...
    static __attribute__((inline)) void timer3_resolution_select(const timer3_config_t *timer3);
    static __attribute__((inline)) void timer3_Synchronization_select(const timer3_config_t *timer3);
# 26 "mcal_layer/Timer3/hal_timer3.c"
std_ReturnType Timer3_Init(const timer3_config_t *timer3) {
    ...
    if (((void*)0) == timer3) {
        ...
        timer3_resolution_select(timer3);
        timer3_Synchronization_select(timer3);
...
# 55 "mcal_layer/Timer3/hal_timer3.c"
    (INTCONbits.GIE = 1);
    (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) void timer3_resolution_select(const timer3_config_t *timer3){
    if( timer3->resolution == 1 ){
        ( T3CONbits.RD16 = 1 );
    }else if(timer3->resolution == 0){
        ( T3CONbits.RD16 = 0 );
    }else{
...
static __attribute__((inline)) void timer3_Synchronization_select(const timer3_config_t *timer3){
    if(0 == timer3->Synchronization){
        (T3CONbits.T3SYNC = 0 );
    }else if(1 == timer3->Synchronization){
        (T3CONbits.T3SYNC = 1 );
    }else{
