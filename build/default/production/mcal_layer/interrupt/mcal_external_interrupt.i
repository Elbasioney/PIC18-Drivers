...
# 1 "mcal_layer/interrupt/../mcal_std_libararies.h" 1
# 10 "mcal_layer/interrupt/../mcal_std_libararies.h"
...
# 10 "mcal_layer/interrupt/../mcal_std_libararies.h" 2
...
# 12 "mcal_layer/interrupt/../mcal_std_libararies.h" 2
...
# 29 "mcal_layer/interrupt/../mcal_std_types.h"
...
# 1 "mcal_layer/interrupt/../GPIO/../../mcal_layer/device_conf.h" 1
...
# 75 "mcal_layer/interrupt/mcal_external_interrupt.h"
typedef enum {
...
std_ReturnType interrupt_INTx_init(const interrupt_INTx_t *interrupt_object) {
    ...
    if (((void*)0) == interrupt_object) {
        ...
        RET_VAL = interrupt_INTx_clear_flag(interrupt_object);
        RET_VAL = interrupt_INTx_edge_init(interrupt_object);



        RET_VAL = interrupt_INTx_pin_init(interrupt_object);
        RET_VAL = interrupt_INTx_set_interrupt_handler(interrupt_object);
        RET_VAL = interrupt_INTx_enable(interrupt_object);
    }
    return RET_VAL;
}
# 132 "mcal_layer/interrupt/mcal_external_interrupt.c"
std_ReturnType interrupt_INTx_deinit(const interrupt_INTx_t *interrupt_object) {
    std_ReturnType RET_VAL = (std_ReturnType)0x00;
    if (((void*)0) == interrupt_object) {
        RET_VAL = (std_ReturnType)0x00;
...
# 241 "mcal_layer/interrupt/mcal_external_interrupt.c"
                (INTCONbits.PEIE = 1);
                (INTCONbits.GIE = 1);
